...
- **Brain:** a Claude agent (`claude-opus-5-5`) with his body, camera, memory, reminders, a few shell commands, the web, skills and MCP servers as tools. `AGENT = False` falls back to the OpenAI model and the `ACTIONS:` line.
